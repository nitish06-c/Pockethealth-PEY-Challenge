...
func (s UserApiService) PostRegister(ctx context.Context, name string, email string, color string) (string, error) {
	// save user to datastore
	userId, err := datastore.CreateUser(ctx, name, email, color)
	if err != nil {
